...
public class CopyOfNioChannelGOOD {
    ...
    public CopyOfNioChannelGOOD(Boolean isServer,int socketPort, String serverIp) throws JAXBException, IOException  
    {
